...
// FUSION OS: Backup state for undo (code 2002)
              ...
              if (entered_code == "1001") {
                ...
                if (backup_exists) {
                  ...
                  if (char_data) {
                    ...
                    gfx->setCursor(centerX - 135, LCD_HEIGHT/2 - 60);
                    gfx->print("RESTORED!");
                    
                    gfx->setTextSize(2);
                    gfx->setTextColor(COLOR_WHITE);
                    gfx->setCursor(centerX - 108, LCD_HEIGHT/2);
                    gfx->print("Level " + String(backup_level) + " ✓");
                    
                    gfx->setCursor(centerX - 120, LCD_HEIGHT/2 + 30);
                    gfx->print("Titles Restored ✓");
                    
                    gfx->setTextSize(1);
                    gfx->setTextColor(RGB565(150, 150, 160));
                    gfx->setCursor(centerX - 50, LCD_HEIGHT/2 + 70);
                    gfx->print("UNDO SUCCESSFUL");
                    
                    Serial.println("[SHOP] UNDO: Restored to Level " + String(backup_level) + ", XP " + String(backup_xp));
                  ...
                  gfx->setTextSize(3);
                  gfx->setTextColor(COLOR_WHITE);
                  gfx->setCursor(centerX - 135, LCD_HEIGHT/2);
                  gfx->print("NO BACKUP!");
                  delay(1500);
                }
              } else {
