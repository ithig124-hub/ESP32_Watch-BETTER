...
#include "types.h"  // Must include types.h for BatteryInfo, IMUData
#include "config.h"
#include "power_manager.h"  // For PowerState enum (5 states: ACTIVE, IDLE, DIMMED, MINIMAL, SCREEN_OFF)
#include <Wire.h>
#include <time.h>
