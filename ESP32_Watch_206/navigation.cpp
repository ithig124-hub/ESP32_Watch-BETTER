...
uint16_t getAppColor(const char* appName) {
  ...
  if (strcmp(appName, "SOCIAL") == 0)    return RGB565(100, 200, 255);
...
void drawAppIcon(int x, int y, int w, int h, const char* name, uint16_t color, bool selected) {
  // ========================================
  // RETRO ANIME APP ICON - FIXED TEXT VISIBILITY
  // ========================================
  ...
  // Subtle scan line effect - stop before text area
  ...
  // =============================================
  // APP NAME TEXT - FIXED FOR VISIBILITY
  // =============================================
  ...
  // Calculate text position (centered) - Size 2 = 12 pixels per char
  ...
  gfx->setTextSize(2);
  gfx->setTextColor(0x0000);  // Pure black shadow
  gfx->setCursor(textX + 1, textY + 1);
  gfx->print(name);
  
  // Draw main text in PURE WHITE
  gfx->setTextColor(0xFFFF);  // Pure white
...
void drawAppGrid1() {
  // ========================================
  // RETRO ANIME APP GRID - CRT Style (Optimized for 410x502)
  // ========================================
  ...
  // Retro header bar with pixel border - taller for bigger display
  int headerH = 55;
  ...
  // App icons - larger for 410x502 display
  ...
  int cols = 3;
  int iconW = 115;  // Larger icons
  int iconH = 100;  // Taller icons
  int gapX = 15;
  int gapY = 12;
...
void drawAppGrid2() {
  // ========================================
  // RETRO ANIME APP GRID PAGE 2 (Optimized for 410x502)
  // ========================================
...
void drawAppGrid3() {
  // ========================================
  // RETRO ANIME APP GRID PAGE 3 (Optimized for 410x502)
  // ========================================
...
void handleAppGridTap(int x, int y) {
  ...
  // App grid hit detection - larger icons for 410x502 display
  int cols = 3;
  int iconW = 115;  // Match drawAppGrid sizes
  int iconH = 100;
  int gapX = 15;
  int gapY = 12;
  int headerH = 55;
